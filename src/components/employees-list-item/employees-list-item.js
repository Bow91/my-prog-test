...
const EmployeesListItem = (props) => {
    ...
    const {name, salary, increase, star, onDelete, onToggleProp, onSalary} = props;
    ...
    return (
        <li className={"list-group-item justify-content-betwen" + incrClass + starClass}>
            ...
            <input type="text" className="list-group-item-input" defaultValue={salary + '$'} onChange = {onSalary}/>
